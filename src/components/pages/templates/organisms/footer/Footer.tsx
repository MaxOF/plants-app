        ...
        <div className={`${styles.container} ${s.footer__container}`}>
          <div className={s.footer__body}>
            <div className={s.footer__addressBlock}>
              <h4 className={s.footer__title}>plantku</h4>
              <div className={s.footer__name}>Plantku House</div>
              <div className={s.footer__address}>
                Jl. Laksda Adisucipto No.51, Demangan, Kec. Depok, Kota Yogyakarta, Daerah Istimewa
                Yogyakarta 55282
              </div>
            </div>
