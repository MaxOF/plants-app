      ...
      <div className={`${styles.container} ${s.intro__container}`}>
        <div className={s.intro__body}>
          <div className={s.intro__textBlock}>
            ...
            <div>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi gravida gravida
              aliquam. Pellentesque et lobortis nisl. Sed et mauris justo. Nulla eu enim non mauris
              maximus dignissim. Maecenas vitae eros sapien. Quisque pellentesque tempus dignissim.
            </div>
          </div>
