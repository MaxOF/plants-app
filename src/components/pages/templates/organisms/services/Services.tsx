        ...
        <div className={s.services__body}>
          <div className={s.services__column}>
            <div className={s.services__item}>
              ...
              <h3 className={s.services__title}>Fast Delivery</h3>
          ...
          <div className={s.services__column}>
            <div className={s.services__item}>
              ...
              <h3 className={s.services__title}>Great Customer Service</h3>
              <div className={s.services__description}>
                Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                Ipsum has been the industry&apos;s standard
              </div>
          ...
          <div className={s.services__column}>
            <div className={s.services__item}>
              ...
              <h3 className={s.services__title}>Original Plants</h3>
              <div className={s.services__description}>
                Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                Ipsum has been the industry&apos;s standard
              </div>
          ...
          <div className={s.services__column}>
            <div className={s.services__item}>
              ...
              <h3 className={s.services__title}>Affordable Price</h3>
              <div className={s.services__description}>
                Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                Ipsum has been the industry&apos;s standard
              </div>
